...
def requestStats():
    ...
    _request = _http.request('GET', 'https://api.lootbox.eu/' +
                             _platform + '/' +
                             _region + '/' +
                             _username + '/heroes')
...
def compareStats(_user1, _user2, _platform, _region):
    ...
    _request1 = _http.request('GET', 'https://api.lootbox.eu/' +
                              _platform + '/' +
                              _region + '/' +
                              _username1 + '/profile')
    _request2 = _http.request('GET', 'https://api.lootbox.eu/' +
                              _platform + '/' +
                              _region + '/' +
                              _username2 + '/profile')
...
if __name__ == "__main__":
    ...
    compareStats('GloverDude#1471', 'adR#1700', 'pc', 'us')
